...
if [ $# -ne 4 ]
then
	echo "Usage: $0 <(constant)[ops|workers]> <constant_count> <var_min> <var_max>"
	echo "Ex:"
	echo "$0 ops 5 1 100           Executes 5 ops on a variable number of workers from 1 to 100"
	echo "$0 workers 5 100 500     Executes 100 to 500 ops on 5 workers"
	exit	
fi
